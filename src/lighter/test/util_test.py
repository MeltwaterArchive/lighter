...
class UtilTest(unittest.TestCase):
    ...
    def testReplaceEscape(self):
        ...
        self.assertEquals(util.replace(
            x, util.FixedVariables({'var': '1'})), m)
