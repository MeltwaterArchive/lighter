...
class DockerTest(unittest.TestCase):
    ...
    def testPrivateV2(self):
        ...
        with patch('lighter.util.jsonRequest', wraps=self._wrapRequest(url, data)):
            ...
            self.assertEquals(service.releaseNotes, 'my lovely release-notes')
